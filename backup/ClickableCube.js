...
import { softShadows, MeshWobbleMaterial, ContactShadows, Environment, useGLTF, useAnimations, Sky  } from "@react-three/drei";
    ...
    return (
      <Canvas style={{height:"100vh",width:"100vw",backgroundColor:"#abfff5"}}>
        <Sky
          ...
          azimuth={0.0412} // Sun rotation around the Y axis from 0 to 1 (default=0.25)
        />
        <Lights />
        <CameraControls />
